...
/*
 * register TrustStore generated by the following command
 * keytool -genkeypair -keysize 2048 -keyalg RSA -alias sample -keystore server_keystore -storepass passwd -storetype PKCS12
 */

javaOptions in ITest ++= Seq(
  s"-DCONFIG_PATH=${baseDirectory.value.getAbsolutePath}/service/service.conf",
  //"-Djavax.net.debug=ssl",
  s"-Djavax.net.ssl.trustStore=${(resourceDirectory in Test).value.getAbsolutePath}/server_keystore",
